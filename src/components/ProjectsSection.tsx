  ...
  const projects = [
    {
      ...
      description: "Temperature Conversion Application built using ReactJS and implemented using Docker",
    ...
    },
    {
      ...
      description: "Development Environment for Laravel Applications Containerized using Docker, with Nginx as the web server, MySQL as the database, and Redis as caching.",
    ...
    },
    {
      ...
      description: "Implementing Security & Optimization in Docker Images, Creating a secure and optimized Docker Image for use in production environments.",
    ...
    },
    {
      ...
      description: "Deployment of Laravel-based e-Library Application using Docker, with Bash Scripting implementation to automate the deployment process within the container.",
    ...
    },
    {
      ...
      description: "Build a simple environment consisting of Api Service and Database, then connect them through Custom Network.",
    ...
    },
    {
      ...
      description: "Implementation of Docker Container Monitoring using Prometheus to collect and store metric data, cAdvisor to collect real-time container resource usage, and Grafana to visualize the data.",
    ...
    },
    {
      ...
      description: "Automate the process of building and pushing Docker Images for NodeJS applications using GitHub Actions as a CI/CD tool.",
    ...
    },
    {
      ...
      description: "Create a simple Docker image, then push the image to GCR (Google Container Registry), and deploy it on Google Kubernetes Engine (GKE).",
    ...
    },
    {
      ...
      description: "Implementation of Application Deployment Process on Google Kubernetes Engine (GKE) using Artifact Registry (AR) as a storage location for Docker Image and Bash to automatically create GKE clusters.",
    ...
    },
    {
      ...
      description: "A collection of project scripts for automating server setup, such as log archive tools, server performance stats, etc.",
    ...
    },
    {
      ...
      description: "This project implements the use of Ansible to automate the server provisioning process from a fresh OS to production readiness. The main focus of this project is security hardening and container environment preparation (Docker environment).",
